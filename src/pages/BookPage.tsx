        ...
        return (
            <div>
                ...
                <div className="flex flex-col items-center">
                    <h2 className="text-3xl font-merienda text-center pt-5">{book.title}</h2>
                    <p className="text-xl  text-center">{book.author}</p>
                ...
                <div className="h-1 m-4 bg-gradient-to-tl from-[#F2BF5E] via-[#F28705] to-[#BF4904]"/>
                <div>
                    <h3 className="text-2xl  text-center font-merienda mt-4">Summary</h3>
