...
const Sidebar = ({isVisible, onCloseClick}: Props) => {
    ...
    return (
        <aside className={`flex flex-col gap-3 pt-3 pl-3 w-2/3 max-w-sm absolute z-50 bg-[#F2F2F2] top-0 h-screen transition-transform ease-in-out ${visibleTransition}`}>
            <p 
